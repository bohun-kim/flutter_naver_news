...
import 'package:flutter_naver_news/screens/screen/health/health_articles.dart';
...
class _HealthState extends State<Health> {
  ...
  Future<List<dynamic>> getAllArticles() async {
    const url =
        'https://newsapi.org/v2/top-headlines?country=kr&category=health&apiKey=74ad5f4d1a52466cbdbc4486848e5a36';
    ...
    List<HealthArticles> newsArticle = [];

    for (var jsonArticle in jsonArray) {
      HealthArticles newsHomeArticles = HealthArticles(
          ...
          if (snapshot.data == null) {
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  HealthArticles article = newsArticles[index];
