...
import 'package:flutter_naver_news/screens/screen/entertainment/entertainment_articles.dart';
...
class _EntertainmentState extends State<Entertainment> {
  ...
  Future<List<dynamic>> getAllArticles() async {
    const url =
        'https://newsapi.org/v2/top-headlines?country=kr&category=entertainment&apiKey=74ad5f4d1a52466cbdbc4486848e5a36';
    ...
    List<EntertainmentArticles> newsArticle = [];

    for (var jsonArticle in jsonArray) {
      EntertainmentArticles newsHomeArticles = EntertainmentArticles(
          ...
          if (snapshot.data == null) {
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  EntertainmentArticles article = newsArticles[index];
