...
class _SportsState extends State<Sports> {
  ...
  Future<List<dynamic>> getAllArticles() async {
    const url =
        'https://newsapi.org/v2/top-headlines?country=kr&category=sports&apiKey=74ad5f4d1a52466cbdbc4486848e5a36';
    ...
    List<SportsArticles> newsArticle = [];

    for (var jsonArticle in jsonArray) {
      SportsArticles newsHomeArticles = SportsArticles(
          ...
          if (snapshot.data == null) {
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  SportsArticles article = newsArticles[index];
