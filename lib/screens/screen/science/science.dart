...
import 'package:flutter_naver_news/screens/screen/science/science_articles.dart';
...
class _ScienceState extends State<Science> {
  ...
  Future<List<dynamic>> getAllArticles() async {
    const url =
        'https://newsapi.org/v2/top-headlines?country=kr&category=science&apiKey=74ad5f4d1a52466cbdbc4486848e5a36';
    ...
    List<ScienceArticles> newsArticle = [];

    for (var jsonArticle in jsonArray) {
      ScienceArticles newsHomeArticles = ScienceArticles(
          ...
          if (snapshot.data == null) {
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ScienceArticles article = newsArticles[index];
